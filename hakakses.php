		...
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="row">
				<table id="myTable" class="table table-bordered table-striped">
					...
					<th>Id</th>
					<th>Keterangan</th>
					<th>Menu Data Dasar</th>
					<th>Menu Prefrensi</th>
					<th>Menu SPPD</th>
					<th>Menu Edit</th>
					<th>Aktion</th>
					</thead>
						...
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									<td>".$row['id']."</td>
									<td>".$row['ket']."</td>
									<td>".$row['menudatadasar']."</td>
									<td>".$row['menupreferensi']."</td>
									<td>".$row['menusppd']."</td>
									<td>".$row['editable']."</td>
									<td>
								...
								include('edit_delete_modal_hakakses.php');
							}
							/////////////////
...
<?php include('add_modal_hakakses.php') ?>
