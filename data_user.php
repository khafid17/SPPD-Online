				...
				<table id="myTable" class="table table-bordered table-striped">
					...
					<tbody>
						<?php
							...
							$sql = "SELECT user.id, user.nama, user.username, transopd.Kd_Urut, transopd.Nm_Unit, user.hakakses, user.status from transopd RIGHT join user on transopd.kd_urut=user.idtrans";
							...
							while($row = $query->fetch_assoc()){
								...
								include('edit_delete_modal_data_user.php');
							}
							/////////////////
...
<?php include('add_modal_data_user.php') ?>
