				...
				<table id="myTable" class="table table-bordered table-striped">
					...
					<tbody>
						<?php
							...
							$sql = "SELECT id,nama,nip,pangkat,instansi,status, if (status = '1', 'aktif','non aktif') FROM bufferpns";
							...
							while($row = $query->fetch_assoc()){
								...
								include('edit_delete_modal_data_pns.php');
							}
							/////////////////
...
<?php include('add_modal_data_pns.php') ?>
